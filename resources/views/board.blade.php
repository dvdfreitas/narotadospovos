<x-guestLayout>
    ...
    <x-margins-text>
        ...
        <div class="border-2 border-solid border-nrp-blue p-4 rounded-lg my-4">
            <p class="font-bold">30 de Março 2019 a 27 de Maio 2022</p>
        ...
        <div class="border-2 border-solid border-nrp-blue p-4 rounded-lg my-4">
            <p class="font-bold">2 de Abril 2016 a 29 de Março 2019</p>
        ...
        <div class="border-2 border-solid border-nrp-blue p-4 rounded-lg my-4">
            <p class="font-bold">8 de Setembro 2012 a 1 de Abril 2016</p>
        ...
        <div class="border-2 border-solid border-nrp-blue p-4 rounded-lg my-4">
            <p class="font-bold">2 de Janeiro 2011 a 7 de Setembro 2012</p>
        ...
        <div class="border-2 border-solid border-nrp-blue p-4 rounded-lg my-4">
            <p class="font-bold">1 de Outubro 2007 a 1 de Janeiro 2011</p>
        ...
        <div class="border-2 border-solid border-nrp-blue p-4 rounded-lg my-4">
            <p class="font-bold">1 de Outubro 2004 a 30 de Setembro 2007</p>
        ...
        <div class="border-2 border-solid border-nrp-blue p-4 rounded-lg my-4">
            <p class="font-bold">2 de Outubro 2001 a 30 de Setembro 2004</p>
        ...
        <div class="border-2 border-solid border-nrp-blue p-4 rounded-lg my-4">
            <p class="font-bold">3 de Agosto de 2001</p>

            <div class="my-2">
                <p class="font-bold">SOCIOS FUNDADORES</p>
                <p>ISABEL CRISTINA PIRES DIAS</p>
                <p>JOÃO PEDRO SILVA PEREIRA</p>
                <p>JORGE PORFÍRIO DIAS SANTOS SILVA</p>
                <p>SÓNIA MARIA CRISTA VIEIRA</p>
                <p>TITO OSVALDO DIAS BAIÃO</p>
            </div>
        </div>
