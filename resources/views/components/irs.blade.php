<div>
    ...
    <x-margins-text>
        ...
        @if (session('language') === 'pt')
            ...
            <p>A Na Rota dos Povos é uma ONGD cuja missão é promo                                                                                                   ver a educação, a proteção social e a saúde na região de Tombali, no sul da Guiné-Bissau. Sob o lema "A Educação é o Único Caminho", trabalhamos para transformar vidas: apoiamos cerca de 50 escolas com material e equipamento escolar, acolhemos na Casa da Mamé crianças que perderam a mãe no parto e proporcionamos apoio especializado a crianças com deficiência no Centro de Educação Especial e Terapêutica.</p>
            ...
            <p>Muito obrigado.</p>
        @else
            <p>The <span class="text-nrp-blue">IRS allocation</span> allows a portion of your tax, which would go to the State, to be directed to an organization of your choice. This act of solidarity has no cost to you and does not affect your tax benefits, but it can mak                                                                                                                                                                                                                                                                                                                                       e a world of difference to those in need.</p>
