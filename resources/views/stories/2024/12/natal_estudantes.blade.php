<x-guestLayout>
    ...
    <x-margins-text>
        ...
        @if (session('language') === 'pt')
            ...
            <p><x-person>Hélder Soares</x-person> e <x-person>Liliana Coimbra</x-person>, dois voluntários da NRP, têm acompanhado estes jovens de mais perto. Hélder destaca a audácia de quem deixa o seu país abraçando este desafio e luta todos os dias para ultrapassar as dificuldades de viver num mundo completamente diferente, em que as coisas mais simples para nós, são muitas vezes um desafio para eles.</p>
