...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
    ...
    <button type="button"
        @click="Livewire.dispatch('open-donation-modal', { type: 'cereal', amount: 5 })"
    ...
    {{-- 3. KIT HIGIENE (20€) --}}
    <button type="button"
        @click="Livewire.dispatch('open-donation-modal', { type: 'food', amount: 25 })"
        ...
        <h3 class="text-lg font-bold text-neutral-800 group-hover:text-purple-600 transition-colors">Cabaz para 1 criança</h3>
